#ifndef DF9506FC_721D_4652_AC46_8D52A1027462
#define DF9506FC_721D_4652_AC46_8D52A1027462
#ifndef IMECLUI_H__
#define IMECLUI_H__
...
#define ime_move_cursor(X, Y) printf("\033[%llu;%lluH", \
...
#define ime_exit_alt_screen() puts("\033[?1049l")
    ...
    ADDAPI void ADDCALL ime_place_buffer(CellBuffer *buf)
    {
        ...
        for (int i = 0; i < buf->rows; i++)
        {
            for (int j = 0; j < buf->cols; j++)
            {
                t = sprintf("%s", screen, ime_style_builder(
...
#endif /* DF9506FC_721D_4652_AC46_8D52A1027462 */
