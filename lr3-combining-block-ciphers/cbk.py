...
# Decrypt with the third key
decipher3 = DES.new(key3, DES.MODE_ECB)
decrypted_padded_data2 = decipher3.decrypt(ciphertext3)

# Encrypt with the second key
decipher2 = DES.new(key2, DES.MODE_ECB)
decrypted_padded_data1 = decipher2.encrypt(decrypted_padded_data2)

# Decrypt with the first key
decipher1 = DES.new(key1, DES.MODE_ECB)
plaintext_padded = decipher1.decrypt(decrypted_padded_data1)
